...
const SubscriptionAction = (props: Props) => {
  ...
  return (
    <div className='flex flex-col items-center w-1/2 p-4 mx-auto mt-4 rounded-md bg-secondary'>
        ...
        <Button disabled={loading} onClick={handleSubscribe} className='mt-3 font-bold text-white transition bg-gradient-to-tr from-green-400 to-blue-400 hover:from-green-500 hover:to-blue-600'>
            Upgrade
